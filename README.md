...
4. Select a username and password. You will use the same credentials when you create the Client-1 VM. Click `Next` until you get to the <b>Networking</b> section.
...
<p>
<img src="https://github.com/user-attachments/assets/66835494-afd9-44b6-b361-0affe744fd69" height="80%" width="80%" alt="Domain Controller Creation"/>
</p></br>
